...
fn main() -> ! {
    ...
    clock_control.start_core(1, test);
    ...
    loop {
        for j in 0..2 {
            ...
            for i in 0..2 {
                ...
                let cpu1count = GLOBAL_COUNT.load(core::sync::atomic::Ordering::Relaxed);

                writeln!(
                    uart0,
                    "Loop: {}, cycles: {}, cycles since previous {}, cpu1: {}",
                    x, ccount, ccount_diff, cpu1count
                )
                .unwrap();
