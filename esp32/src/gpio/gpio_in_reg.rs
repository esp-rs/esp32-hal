...
impl From<PIN229_A> for bool {
    #[inline(always)]
    fn from(variant: PIN229_A) -> Self {
        match variant {
            PIN229_A::LOW => false,
            PIN229_A::HIGH => true,
        }
...
#[doc = "Reader of field `PIN229`"]
pub type PIN229_R = crate::R<bool, PIN229_A>;
impl PIN229_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> PIN229_A {
        match self.bits {
            false => PIN229_A::LOW,
            true => PIN229_A::HIGH,
        }
...
#[doc = "Write proxy for field `PIN229`"]
pub struct PIN229_W<'a> {
    w: &'a mut W,
}
impl<'a> PIN229_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: PIN229_A) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
    ...
    #[inline(always)]
    pub fn low(self) -> &'a mut W {
        self.variant(PIN229_A::LOW)
    }
    #[doc = "High level"]
    #[inline(always)]
    pub fn high(self) -> &'a mut W {
        self.variant(PIN229_A::HIGH)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl R {
    ...
    #[doc = "Bit 29 - Input value"]
    #[inline(always)]
    pub fn pin229(&self) -> PIN229_R {
        PIN229_R::new(((self.bits >> 29) & 0x01) != 0)
    }
    #[doc = "Bit 30 - Input value"]
    #[inline(always)]
    pub fn pin30(&self) -> PIN30_R {
        PIN30_R::new(((self.bits >> 30) & 0x01) != 0)
    }
    #[doc = "Bit 31 - Input value"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 29 - Input value"]
    #[inline(always)]
    pub fn pin229(&mut self) -> PIN229_W {
        PIN229_W { w: self }
    }
    #[doc = "Bit 30 - Input value"]
    #[inline(always)]
